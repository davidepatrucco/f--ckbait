# Store listing — LemonSqueezer — TL;DR

**Nome (store):** LemonSqueezer — TL;DR
**Categoria:** Productivity
**Tagline:** Skip the noise. Get the point.
**Privacy:** https://lemonsqueezer.app/privacy-policy.html
**Termini:** https://lemonsqueezer.app/terms.html
**Supporto:** mailto:contact@bifa.digital

## Descrizione breve (≤132 caratteri)
TL;DR di qualsiasi pagina in un clic: i punti chiave, senza rumore. Riassunti nella tua lingua.
_(95 caratteri)_

## Descrizione dettagliata
LemonSqueezer riassume qualsiasi articolo o pagina web in pochi secondi: i punti essenziali in bullet, nella lingua che scegli, con un clic.
...
• Funziona su articoli, blog, documentazione, PDF (anche aperti da file locale) e video: YouTube e qualsiasi video con sottotitoli; con Premium anche trascrizione dell'audio
...
## Keywords
tldr, summary, riassunto, articoli, produttività, reading
